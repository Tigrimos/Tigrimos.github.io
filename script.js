...
document.querySelectorAll('.feature-card, .sec-card, .deploy-card, .download-card, .deploy-step, .budget-card, .pain-row, .remote-card, .service-card').forEach(el => {
  el.style.opacity = '0';
...
document.querySelectorAll('.features-grid, .security-grid, .deploy-grid, .download-grid, .budget-grid, .pain-list, .remote-grid, .services-grid').forEach(grid => {
